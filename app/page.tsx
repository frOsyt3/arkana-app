...
import { Building2, Users, Lightbulb, ArrowRight, CheckCircle2, TrendingUp, Award, Target, Cloud, Code, Shield, Zap, BarChart, Star } from "lucide-react"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {companyInfo.services.map((service, index) => {
              const icons: Record<string, any> = {
                Cloud, Code, Shield, Zap, Lightbulb, BarChart
              };
